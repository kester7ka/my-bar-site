...
const navMap = {
  ...
  'nav-profile': () => {
    ...
    let uname = username ? escapeHtml(username) : 'Гость';
    let bar = USER && USER.bar_name ? escapeHtml(USER.bar_name) : '—';
    let photo = userPhoto ? `<img src="${userPhoto}" alt="avatar" class="user-avatar" style="width:88px;height:88px;box-shadow:0 2px 18px #7b7bff55,0 2px 1.5px #232b33 inset;border:3px solid #232b33;background:#232b33;object-fit:cover;">` : `<div class="user-avatar" style="width:88px;height:88px;display:flex;align-items:center;justify-content:center;background:#232b33;color:#7b7bff;font-size:2.7em;">👤</div>`;
    let html = `
      <div class="beautiful-form" style="max-width:420px;margin:38px auto 0 auto;padding:38px 18px 34px 18px;box-shadow:0 8px 40px #7b7bff33,0 1.5px 7px #232b3340,0 1.5px 0.5px #fff2 inset;border:2px solid #7b7bff33;border-radius:32px;animation:popIn 0.7s;display:flex;flex-direction:column;align-items:center;gap:18px;">
        ${photo}
        ...
        <div style="color:#888;font-size:1.02em;text-align:center;margin-bottom:0;">Версия приложения: <span style="color:#7b7bff;font-weight:700;">0.7</span></div>
      </div>
    `;
    showPage(html);
  },
