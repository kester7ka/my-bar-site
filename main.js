...
function showAddPage() {
  ...
  showPage(addBackButton(`
    <form id="addf" class="beautiful-form add-form-modern" autocomplete="off" style="max-width:420px;padding:28px 12px 24px 12px;box-shadow:0 8px 40px #7b7bff33, 0 1.5px 7px #232b3340, 0 1.5px 0.5px #fff2 inset;border:2px solid #7b7bff33;border-radius:28px;">
      <div style="display:flex;align-items:center;gap:14px;margin-bottom:18px;">
        <div style="background:#232b33;border-radius:14px;padding:10px 14px;box-shadow:0 2px 12px #7b7bff22;display:flex;align-items:center;justify-content:center;">
          <svg xmlns='http://www.w3.org/2000/svg' width='32' height='32' fill='none' viewBox='0 0 256 256'><path fill='#7b7bff' d='M128 24a104 104 0 1 0 104 104A104.12 104.12 0 0 0 128 24Zm0 192a88 88 0 1 1 88-88a88.1 88.1 0 0 1-88 88Z'/><path fill='#7b7bff' d='M128 80a12 12 0 0 1 12 12v32a12 12 0 0 1-24 0v-32a12 12 0 0 1 12-12Zm0 88a16 16 0 1 0 0-32 16 16 0 0 0 0 32Z'/></svg>
        </div>
        <div style="font-size:1.25em;font-weight:800;color:#7b7bff;letter-spacing:0.01em;">Добавить позицию</div>
      </div>
      <div class="status-toggle-bar" id="statusToggleBar" style="margin-bottom:14px;margin-top:2px;gap:10px;">
        <button type="button" class="status-toggle-btn opened selected" id="btnOpened" aria-pressed="true" style="font-size:1.1em;padding:15px 0;display:flex;align-items:center;gap:8px;"><span style="font-size:1.2em;">🟣</span> Открыто</button>
        <button type="button" class="status-toggle-btn closed" id="btnClosed" aria-pressed="false" style="font-size:1.1em;padding:15px 0;display:flex;align-items:center;gap:8px;"><span style="font-size:1.2em;">🔴</span> Закрыто</button>
      </div>
      <div class="field-row" style="margin-bottom:12px;">
        <label class="field-label" for="category">Категория</label>
        <select name="category" id="category" required style="background:#232b33;color:#fff;border:none;font-size:1.1em;outline:none;border-radius:12px;padding:10px 12px;">
      ...
      <div class="field-row" style="margin-bottom:12px;">
        <label class="field-label" for="tob">TOB <span style="color:#888;font-size:0.95em;">(6 цифр)</span></label>
        <input name="tob" id="tob" maxlength="6" pattern="\\d{6}" required placeholder="123456" autocomplete="off" inputmode="numeric" style="background:#232b33;color:#fff;border:none;font-size:1.1em;outline:none;border-radius:12px;padding:10px 12px;">
        <div id="tobWarning" style="display:none;font-size:0.98em;color:#ff6b81;margin-top:3px;"></div>
      </div>
      <div class="field-row" style="margin-bottom:12px;">
        <label class="field-label" for="name">Название</label>
        <input name="name" id="name" required placeholder="Название позиции" style="background:#232b33;color:#fff;border:none;font-size:1.1em;outline:none;border-radius:12px;padding:10px 12px;">
      </div>
      <div class="field-row" style="margin-bottom:12px;">
        <label class="field-label" for="manufactured_at">Дата производства</label>
        <input name="manufactured_at" id="manufactured_at" type="date" required style="background:#232b33;color:#fff;border:none;font-size:1.1em;outline:none;border-radius:12px;padding:10px 12px;">
      </div>
      <div class="field-row" style="margin-bottom:12px;display:flex;gap:10px;">
        <div style="flex:1;">
          <label class="field-label" for="shelf_life_days">Срок годности (дней)</label>
          <input name="shelf_life_days" id="shelf_life_days" type="number" min="1" required placeholder="180" style="background:#232b33;color:#fff;border:none;font-size:1.1em;outline:none;border-radius:12px;padding:10px 12px;">
        </div>
        <div style="flex:1;">
          <label class="field-label" for="opened_shelf_life_days">После вскрытия (дней)</label>
          <input name="opened_shelf_life_days" id="opened_shelf_life_days" type="number" min="1" required placeholder="30" style="background:#232b33;color:#fff;border:none;font-size:1.1em;outline:none;border-radius:12px;padding:10px 12px;">
        </div>
      </div>
      <div class="field-row" id="openedAtRow" style="display:none;margin-bottom:12px;">
        <label class="field-label" for="opened_at">Дата вскрытия</label>
        <input name="opened_at" id="opened_at" type="date" style="background:#232b33;color:#fff;border:none;font-size:1.1em;outline:none;border-radius:12px;padding:10px 12px;">
      </div>
  ...
  function updateStatusButtons() {
    if (opened) {
      ...
      btnOpened.setAttribute('aria-pressed', 'true');
      btnClosed.setAttribute('aria-pressed', 'false');
      openedAtRow.style.display = '';
    } else {
      btnOpened.classList.remove("selected", "opened");
      btnClosed.classList.add("selected", "closed");
      btnOpened.setAttribute('aria-pressed', 'false');
      btnClosed.setAttribute('aria-pressed', 'true');
